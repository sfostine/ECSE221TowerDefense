...
public class MapPanel extends JPanel implements MouseListener{
	...
	public MapPanel(){
	 ...
	 public void mouseClicked(MouseEvent e) {
	  ...
	  if((ButtonPanel.isBuildCannon || ButtonPanel.isBuildRocket || ButtonPanel.isBuildBow) && (GameFrame.getGUIScreen().getGUIMap().getDomainMap().isScenery(domainX/Value.pathCellSize, domainY/Value.pathCellSize))){
	   this.buildTower((domainX/Value.pathCellSize * Value.pathCellSize) + offSetX, (domainY/Value.pathCellSize * Value.pathCellSize) + offSetY);
	  }else if(ButtonPanel.isBuildCannon || ButtonPanel.isBuildRocket || ButtonPanel.isBuildBow){
