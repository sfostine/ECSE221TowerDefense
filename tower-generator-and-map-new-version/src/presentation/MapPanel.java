...
public class MapPanel extends JPanel implements MouseListener{
	...
	public MapPanel(){
	 ...
	 public void mouseClicked(MouseEvent e) {
	  ...
	  if((ButtonPanel.isBuildCannon || ButtonPanel.isBuildRocket || ButtonPanel.isBuildBow) && (GameFrame.getGUIScreen().getGUIMap().getDomainMap().isScenery(e.getX()/Value.getPathCellSize(), e.getY()/Value.getPathCellSize()))){
	   this.buildTower(e.getX()/Value.getPathCellSize() * Value.getPathCellSize(), e.getY()/Value.getPathCellSize() * Value.getPathCellSize());
	  }else{
